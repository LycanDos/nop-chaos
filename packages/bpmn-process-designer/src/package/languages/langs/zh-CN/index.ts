export default {
  bpmn: {
    ...
    'Executor task': '执行器任务',
    'An Executor invocation task bound to LProcessConsole executors.': '绑定 LProcessConsole 执行器的调用任务。',
    ...
    'Missing executor binding configuration': '缺少执行器绑定配置',
    'Missing executor selection': '缺少执行器选择',
    'Missing executor method selection': '缺少执行器方法选择',
