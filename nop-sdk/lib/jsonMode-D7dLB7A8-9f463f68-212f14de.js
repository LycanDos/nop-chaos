...
(function(e) {
  function r(n, t, o) {
    let s = { title: n }, u = true;
    return typeof t == "string" ? (u = false, s.kind = t) : U.is(t) ? s.command = t : s.edit = t, u && o !== void 0 && (s.kind = o), s;
  }
  e.create = r;
  function i(n) {
    let t = n;
...
function an(e) {
  return {
    getInitialState: () => new wt(null, null, false, null),
...
var dt = "delimiter.bracket.json", gt = "delimiter.array.json", un = "delimiter.colon.json", cn = "delimiter.comma.json", ln = "keyword.json", fn = "keyword.json", dn = "string.value.json", gn = "number.json", pn = "string.key.json", vn = "comment.block.json", mn = "comment.line.json", x = class bt {
  ...
  equals(r) {
    return r === this ? true : !r || !(r instanceof ce) ? false : this.scanError === r.scanError && this.lastWasColon === r.lastWasColon && x.equals(this.parents, r.parents);
  }
  getStateData() {
    return this._state;
  }
...
function Nn(e) {
  ...
  function t() {
    ...
    ), u.tokens && i.push(f.languages.setTokensProvider(s, an(true))), u.colors && i.push(
