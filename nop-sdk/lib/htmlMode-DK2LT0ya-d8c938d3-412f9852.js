import { u4 } from "./index-2dc973b9.js";
import "amis-core";
import "react";
import "amis-ui";
import "amis";
...
(function(e) {
  function n(r, t, o) {
    let s = { title: r }, u = true;
    return typeof t == "string" ? (u = false, s.kind = t) : E.is(t) ? s.command = t : s.edit = t, u && o !== void 0 && (s.kind = o), s;
  }
  e.create = n;
  function i(r) {
    let t = r;
...
function Ht(e) {
  ...
  let r = e.languageId;
  c.languages.registerCompletionItemProvider(r, new ct(i)), c.languages.registerHoverProvider(r, new Ye(i)), c.languages.registerDocumentHighlightProvider(
    r,
    new Je(i)
  ), c.languages.registerLinkProvider(r, new nt(i)), c.languages.registerFoldingRangeProvider(
    r,
    new st(i)
    ...
    r,
    new ut(i)
  ), c.languages.registerRenameProvider(r, new Ke(i)), r === "html" && (c.languages.registerDocumentFormattingEditProvider(
    r,
    new it(i)
...
function Tt(e) {
  ...
  function o() {
    ...
    dt(i), u.completionItems && i.push(
      c.languages.registerCompletionItemProvider(s, new ct(t))
    ), u.hovers && i.push(
      c.languages.registerHoverProvider(s, new Ye(t))
      ...
      c.languages.registerLinkProvider(s, new nt(t))
      ...
      c.languages.registerRenameProvider(s, new Ke(t))
